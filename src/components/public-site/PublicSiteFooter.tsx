          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              {['Mentions légales', 'Politique de confidentialité'].map((label) => (
                <a key={label} href="#" className="text-muted-foreground hover:text-primary transition-colors relative group">
                  <span className="relative">{label}<span className="absolute bottom-0 left-0 w-0 h-px bg-primary group-hover:w-full transition-all duration-300" /></span>
                </a>
              ))}
            </div>
          </div>
