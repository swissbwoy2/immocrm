      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="inline-flex items-center gap-2 mb-6">
            <div className="backdrop-blur-xl rounded-full px-6 py-3 border border-white/20 bg-white/5 shadow-2xl">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-amber-300 uppercase tracking-wider">Accès Privilégié</span>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-[1fr_1.5fr_1.5fr] gap-6 mb-6">
              ...
              <div className="relative backdrop-blur-xl rounded-2xl p-5 bg-white/5 border border-white/10">
                <div className="flex items-center justify-center gap-3">
                  <div className="p-2 rounded-xl bg-white/5"><X className="h-5 w-5 text-slate-500" /></div>
              ...
              {displayData.map((row, index) => (
                <div key={index} className="grid grid-cols-[1fr_1.5fr_1.5fr] gap-6 animate-fade-in group" style={{ animationDelay: `${index * 50}ms` }}>
                  ...
                  <div className="relative backdrop-blur-xl rounded-xl p-4 bg-white/[0.02] border border-white/5">
                    <div className="flex items-start gap-2">
                      <div className="flex-shrink-0 p-1 rounded-full bg-red-500/20 border border-red-500/30"><X className="h-3.5 w-3.5 text-red-400" /></div>
          ...
          <div className="flex justify-center mt-8">
            <Button variant="ghost" onClick={() => setShowMore(!showMore)} className="text-slate-300 hover:text-white hover:bg-white/10 gap-2">
          ...
          <div className="relative w-full max-w-3xl mx-auto">
            <div className="backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-12 bg-gradient-to-br from-white/10 to-white/5 border border-white/20 shadow-2xl overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="mt-4 sm:mt-6 text-xs sm:text-sm text-slate-400">{content.guarantee}</p>
              </div>
            </div>
          </div>
          <p className="mt-6 sm:mt-8 text-xs sm:text-sm text-slate-500 px-4">* Plus de 500 mandats confiés avec succès en Suisse romande depuis 2016</p>
        </div>
      </div>
    </section>
  );
