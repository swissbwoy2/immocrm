    ...
    <section id="services" className="py-24 md:py-32 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <p className="text-xs sm:text-sm tracking-widest uppercase text-primary font-medium mb-3">Ce que vous obtenez</p>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground">Un accompagnement complet, de A à Z</h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {deliverables.map((d, i) => (
            <div key={i} className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-8 space-y-3 hover:border-primary/30 transition-colors">
