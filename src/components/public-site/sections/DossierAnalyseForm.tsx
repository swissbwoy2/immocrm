...
import { ArrowRight, ArrowLeft, CheckCircle, Loader2, User, Phone, Mail, MapPin, ShieldCheck, ClipboardCheck } from 'lucide-react';
...
export function DossierAnalyseForm() {
  ...
  if (step === 'submitted') {
    return (
      <section id="etape-1-qualification" className="py-24 md:py-32 bg-gradient-to-b from-muted/30 to-background">
