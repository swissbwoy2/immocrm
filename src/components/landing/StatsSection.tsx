  ...
  return (
    <section id="stats-section" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-[10%] w-64 h-64 bg-primary/10 rounded-full blur-3xl animate-pulse hidden md:block" style={{ animationDuration: '5s' }} />
        <div className="absolute bottom-20 right-[10%] w-80 h-80 bg-primary/10 rounded-full blur-3xl animate-pulse hidden md:block" style={{ animationDuration: '7s', animationDelay: '2s' }} />
            ...
            >
              ...
              >
                ...
                <div 
                  ...
                  style={{ boxShadow: `0 0 40px ${stat.glowColor}, inset 0 0 20px ${stat.glowColor.replace('0.4', '0.1')}` }}
                />
                ...
                <div className="relative mx-auto w-16 h-16 mb-4">
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${stat.gradient} flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg relative z-10`}>
                    <stat.icon className="h-8 w-8 text-white" />
                  </div>
                  {/* Glow effect behind icon */}
                  <div className={`absolute inset-0 w-16 h-16 rounded-2xl bg-gradient-to-br ${stat.gradient} blur-xl opacity-0 group-hover:opacity-60 transition-opacity`} />
                </div>
