...
export function HeroSection() {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Large animated orbs */}
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-primary/30 to-primary/5 rounded-full blur-3xl animate-pulse" style={{
        animationDuration: "4s"
      }} />
        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-gradient-to-tr from-primary/20 to-transparent rounded-full blur-3xl animate-pulse" style={{
        animationDuration: "6s",
        animationDelay: "1s"
      }} />
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-gradient-to-bl from-primary/25 to-transparent rounded-full blur-2xl animate-pulse hidden md:block" style={{
        animationDuration: "5s",
        animationDelay: "2s"
      }} />

        {/* Sparkle particles - hidden on mobile */}
        {[...Array(8)].map((_, i) => <div key={i} className="absolute hidden md:block" style={{
        top: `${15 + Math.random() * 70}%`,
        left: `${10 + Math.random() * 80}%`,
        animationDelay: `${i * 0.5}s`
      }}>
            <Sparkles className="h-4 w-4 text-primary/40 animate-pulse" style={{
          animationDuration: `${2 + Math.random() * 2}s`
        }} />
          </div>)}

        {/* Geometric shapes - hidden on mobile */}
        <div className="absolute top-[25%] left-[10%] w-20 h-20 border border-primary/30 rounded-xl rotate-45 animate-spin hidden lg:block" style={{
        animationDuration: "20s"
      }} />
        <div className="absolute bottom-[25%] right-[10%] w-16 h-16 border border-primary/20 rounded-full animate-spin hidden lg:block" style={{
        animationDuration: "15s",
        animationDirection: "reverse"
      }} />
        <div className="absolute top-[15%] right-[20%] w-12 h-12 bg-gradient-to-br from-primary/20 to-transparent rounded-lg rotate-12 animate-bounce hidden lg:block" style={{
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in mb-4 relative" style={{
          animationDelay: "50ms"
        }}>
            <div className="absolute inset-0 bg-primary/30 blur-3xl rounded-full scale-150 opacity-60 animate-pulse" style={{
            animationDuration: "3s"
          }} />
            <div className="absolute inset-0 bg-gradient-to-r from-primary/20 via-primary/40 to-primary/20 blur-2xl rounded-full scale-125 animate-pulse" style={{
            animationDuration: "4s",
            animationDelay: "0.5s"
          }} />
        ...
        }}>🏠 On te trouve ton appart' aujourd'hui !</p>
          ...
          <div className="animate-fade-in mb-6 md:mb-8 group" style={{
