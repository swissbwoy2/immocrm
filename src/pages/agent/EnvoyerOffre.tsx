...
const EnvoyerOffre = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      }, { prenom: client?.profiles?.prenom, nom: client?.profiles?.nom });
            ...
            <Card className="p-6">
              ...
              <div className="border rounded-lg p-6 bg-white space-y-4">
                ...
                <div className="border-t pt-4 text-sm text-muted-foreground text-center">
                  <p>Pour toute question, n'hésitez pas à nous appeler au +41 21 634 31 61 ou à répondre directement à cet email.</p>
