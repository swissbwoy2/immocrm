...
import { Globe, FileText, MessageSquare, Bell } from 'lucide-react';
...
const quickLinks = [
  { icon: FileText, label: 'Mes documents', sub: 'Pièces administratives', path: '/client/documents' },
    ...
    <div className="flex-1 overflow-y-auto">
      <PremiumPageShellV2>
        <PremiumPageHeaderV2
          ...
          subtitle="Votre relocation est entre de bonnes mains"
          breadcrumbs={[{ label: 'Espace Client' }, { label: 'Relocation' }]}
          actions={
